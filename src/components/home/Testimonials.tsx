...
const testimonials = [
  {
    ...
    content: "La barra de avellana es increíble. Mi familia la adora y me encanta saber que estoy alimentándolos con algo nutritivo y delicioso.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Finalmente encontré una marca que entiende mis necesidades nutricionales. Las barras sin azúcar son mi debilidad saludable.",
    rating: 5,
